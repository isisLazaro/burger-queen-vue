  ...
  <v-app id="app">
      ...
      <v-list dense>
        <template>
          <v-list-group>
            ...
            <v-list-item :to="{ name: 'createuser' }">
              <v-list-item-action>
                <v-icon></v-icon>
              </v-list-item-action>
              <v-list-item-content>
        ...
        <template>
          <v-list-group>
            <v-list-item slot="activator">
              <v-list-item-content>
                <v-list-item-title>MODIFICAR CARTA</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
            <v-list-item :to="{ name: '' }">
              <v-list-item-action>
        ...
        <template>
          <v-list-group>
            ...
            <v-list-item :to="{ name: '' }">
              ...
              <v-list-item-content>
                <v-list-item-title>CONSULTA VENTA</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </v-list-group>
        </template>
    ...
    >
      <v-toolbar-title style="width: 300px" class="ml-0 pl-3">
        ...
        <span class="hidden-sm-and-down">ADMINISTRADORA</span>
      </v-toolbar-title>
      <v-spacer></v-spacer>
      <v-btn icon>
